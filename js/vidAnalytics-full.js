addListeners(document.getElementById('video'));


function toggleNotes() 
{
    var pxs = document.getElementsById('pxs');
...
function logEvent(evt, color) 
{
    ...
    note.style.opacity = document.getElementById('pxs').className == 'on' ? '1' : '0';
    ...
    var eventslog = document.getElementById('pxs');
